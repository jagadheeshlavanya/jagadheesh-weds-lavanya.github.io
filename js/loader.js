...
function revealSite() {
    if (!loader) return;
    // Keep the 3D rings running the whole time — just dim them behind
    // the page instead of stopping the render loop.
    document.body.classList.add("opened");
    if (typeof window.__scene3dToBackground === "function") window.__scene3dToBackground();
